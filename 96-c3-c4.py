...
def train_test_model(logdir, hparams):
    global model_c3, model_c4
    model_c3_2 = layers.Flatten()(model_c3.layers[-1].output)
    model_c4_2 = layers.Flatten()(model_c4.layers[-1].output)
    model = layers.Concatenate()([model_c3_2, model_c4_2])
    ...
    print(model_c3.input)

    model = Model(inputs=[model_c3.input, model_c4.input], output=model)
    # model.summary()
