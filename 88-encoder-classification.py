...
from keras.layers import Dense, Conv2D, Input, MaxPooling2D, Flatten, AveragePooling2D, GlobalAveragePooling2D, UpSampling2D, Dropout
...
logdir = 'logs/tensorboard/88-tf1-v1/'
run_name = 'run7-128-64'
...
def train_model(logdir, hp):
    ...
    model2.compile(optimizer=optimizers.Adam(lr=hp['lr'], decay=0.01), loss='binary_crossentropy', metrics=['accuracy'])
